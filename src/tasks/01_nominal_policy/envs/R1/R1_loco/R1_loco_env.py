...
from .R1_loco_env_cfg import R1LocoEnvCfg


class R1LocoEnv(R1BaseEnv):
    cfg: R1LocoEnvCfg

    def __init__(self, cfg: R1LocoEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        heading_rewards = torch.exp(-heading_error / 0.2)
